...
{
		/*if ( form.txtMonth.selectedIndex == 0 | form.txtDay.selectedIndex == 0 | form.txtYear.selectedIndex == 0) {
				alert("Month, day, and year must all be selected!")
				form.txtMonth.focus()
				return false
			}*/
...
<form method="post" name="Calendar" action="bottom.asp" Onsubmit= "return validForm(this)">
...
<input type="text" name="txtTopic1" size="40" maxlength="250">&nbsp;<input type="submit" name="txtSubmit" value="Add!" class=inputclass></td></tr>
</table>
</form>
<% 
 if strTopic1 <> "" then 'something was entered so we gots to da SQL stuff!
